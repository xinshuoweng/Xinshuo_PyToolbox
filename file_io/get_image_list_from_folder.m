...
function [full_image_list, num_image] = get_image_list_from_folder(folder_path, save_fullpath)
    ...
    imagelist_subfolder = remove_empty_cell(cellfun(@(x) get_image_list_from_cur_folder(x), subfolder_list, 'UniformOutput', false));	
    imagelist_curfolder = get_image_list_from_cur_folder(folder_path);
