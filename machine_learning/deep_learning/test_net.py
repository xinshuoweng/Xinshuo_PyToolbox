...
# 	print(model.layers['input'].top[0])
# 	assert model.layers['input'].top[0] is model.layers['conv1']
# 	assert model.layers['conv1'].bottom[0] is inputlayer1

# 	model.add(Convolution(name='conv2_1', bottom=conv1, nOutputPlane=128, kernal_size=3, padding=1))
# 	assert model.layers['conv1'].top is model.layers['conv2_1']
# 	assert model.layers['conv2_1'].bottom is model.layers['conv1']
	
# 	model.add(Convolution(name='conv2_2', bottom=conv1, nOutputPlane=128, kernal_size=3, padding=1))
# 	assert model.layers['conv1'].top is [model.layers['conv2_1'], model.layers['conv2_2']]
# 	assert model.layers['conv2_2'].bottom is model.layers['conv1']
