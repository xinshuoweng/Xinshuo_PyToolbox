...
import init_paths
from image_processing import pad_around
...
def test_pad_around():
	...
	pad_rect = [0, 2, 1, 1]
	img_padded = pad_around(np_data, pad_rect=pad_rect, pad_value=10)
	print(np_data)
	print(img_padded)
	...
	img_padded = pad_around(img, [50, 100, 150, 200], pad_value=150)
	visualize_image(img_padded, vis=True)

	img_padded = pad_around(img.convert('L'), [50, 100, 150, 200], pad_value=10)
	visualize_image(img_padded, vis=True)
