...
import init_paths
from image_processing import image_find_local_peaks
...
def test_image_find_local_peaks():
	...
	peak_array = image_find_local_peaks(img)
	...
	input_pts = [[300, 400, 1], [300, 350, 1], [200, 350, 1], [280, 320, 1], [330, 270, 1]]
	image_size = [800, 600]
	std = 50
	heatmap, _, _ = generate_gaussian_heatmap(input_pts, image_size=image_size, std=std)
	img = 1 - heatmap[:, :, -1]
